...
class UserAdmin(DjangoUserAdmin):
    fieldsets = (
        ...
        (
            ...
            {"fields": ("first_name", "last_name", "character_id", "date_of_birth", "place_of_work", "bank_account", "defence_level", "system_heat", "has_special_hack_value", "special_hack_pro_price")}
        ),
        (
        ...
        (
            ...
            {"fields": ("is_active", "is_staff", "is_superuser", "groups", "user_permissions", "is_verified", 'is_service_account', 'is_corporate_fiction_account', "is_fiction_account")},
        ),
    )
    add_fieldsets = ((None, {"classes": ("wide",), "fields": ("email", "password1", "password2")}),)
    list_display = ("email", "first_name", "last_name", "is_staff", "is_active", 'character_id')
