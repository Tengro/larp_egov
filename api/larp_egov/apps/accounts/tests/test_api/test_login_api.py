...
LOGIN_SERIALIZER_PATH = "larp_egov.apps.accounts.api.v1.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch("larp_egov.apps.accounts.services.login.LoginService.login", return_value=mocked_response)
